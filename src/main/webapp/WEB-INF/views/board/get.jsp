				...
				for(let i = 0; i < list.length; i++){
					...
					<div class="media">
					  <div class="media-body">
					    <h5 class="mt-0"><i class="fas fa-caret-right"></i> 
					    ...
					    <div class="input-group" style="display:none;">
							...
							<div class="input-group-append">
								<button class="btn btn-outline-secondary cancel-button"><i class="far fa-window-close"></i></button>
								<button class="btn btn-outline-secondary" id="sendReply\${list[i].id}"><i class="far fa-comment"></i></i></button>
							</div>
						</div>
					  </div>
					</div>`);
